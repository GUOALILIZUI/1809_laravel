...
<div>
        <div class="g-pay-lst">
            <ul>
                ...
                <li order_number="{{$v->order_number}}" id="onum" order_id="{{$v->order_id}}">
                    <a href="">
                        <span>
                        ...
                        <dl>
                            ...
                            <dd><em class="num">1</em>人次/￥<em class="price">{{$v->goods_selfprice}}</em></dd>
                        </dl>
                    </a>
                </li>
                    @endforeach
        ...
        <div class="g-Total-bt">
            <dd id="cc"><a id="btnPay" href="/pay?order_id={{$arr[0]->order_id}}" class="orangeBtn fr w_account" >立即支付</a></dd>


            <dd><a id="dizhi" href="/address" class="orangeBtn fr w_account">编辑收货地址</a></dd>
        </div>
...
<script>
    ...
    $('#bb').click(function(){
        $('#cc').html('<a id="btnPay" href="/NativePay?order_number={{$arr[0]->order_number}}" class="orangeBtn fr w_account" >立即支付</a>')
    })
    $('#aa').click(function(){
        $('#cc').html('<a id="btnPay" href="/pay?order_id={{$arr[0]->order_id}}" class="orangeBtn fr w_account" >立即支付</a>')
    })
