    ...
    <div class="wrapper">
        ...
        <div class="registerCon">
            <ul>
                <li class="accAndPwd">
                    <dl>
                        <s class="phone"></s><input id="userMobile" name="l_name" maxlength="11" type="number" placeholder="请输入您的手机号码" value="" />
                        <span class="clear">x</span>
                    </dl>
                    <dl>
                        <s class="phone"></s><input id="code" name="code" maxlength="11" type="number"  placeholder="验证码" style="width:60%;" value="" />
                        <span class="clear" >x</span>
                        <button type="button" class="layui-btn testBtn-a" id="dateBtn1"  >获取验证码</button>
                    </dl>
                    <dl>
                        <s class="password"></s>
                        <input class="pwd" maxlength="11" type="text" placeholder="6-16位数字、字母组成" value="" />
                        <input class="pwd" maxlength="11" name="l_pwd" type="password" placeholder="6-16位数字、字母组成" value="" style="display: none" />
                    ...
                    <dl>
                        ...
                        <input class="conpwd" maxlength="11" name="l_pwd" type="password" placeholder="请确认密码" value="" style="display: none" />
                        <span class="mr clear">x</span>
                        <s class="eyeclose"></s>
                    </dl>
                    <dl class="a-set">
